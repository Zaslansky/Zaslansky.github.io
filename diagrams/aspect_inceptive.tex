...
\begin{tikzpicture}[label distance=5mm]
  ...
  \draw [|-<, solid] (-2.5,0.75) node [] {} -- (-0.5,0.75) node[midway,above,sloped] (TextNode) {\tiny ``He started talking.''};

    \draw [|-<, solid] (0.5,0.75) node [] {} -- (2.5,0.75) node[midway,above,sloped] (TextNode) {\tiny ``We'll begin at 5.''};
 ...
 \draw (0,1.2) node[anchor=south]{Inceptive};
